...
- **操作系统**：Windows 11
- **工作区路径**：`E:\liushujian-student-course\spring-runtime-principle-two`
- **代码作者**：ThinkPad
- **构建工具**：Maven
...
- **主类**：`com.tencent.principle.SpringRuntimePrincipleTwoApplication`
- **Maven跳过打包**：配置了 `<skip>true</skip>`，可通过Maven命令手动打包
- **编译配置**：
  - 源码版本：1.8
  - 目标版本：1.8
  - 编码：UTF-8
