...
- **工作目录**：`E:\liushujian-student-course\springboot-framework-mybatis-fifth`
- **操作系统**：Windows 11
- **代码作者**：ThinkPad
- **构建工具**：Maven
- **Java 版本**：1.8
...
```
springboot-framework-mybatis-fifth
├── src
│   ├── main
│   │   ├── java
│   │   │   └── com
...
| **Mapper**     | MyBatis 映射接口，负责数据库访问   | 使用 XML 或注解方式定义 SQL；避免复杂业务逻辑                 |
